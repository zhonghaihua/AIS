...
public class TaskMessage implements org.apache.thrift.TBase<TaskMessage, TaskMessage._Fields>, java.io.Serializable, Cloneable, Comparable<TaskMessage> {
  ...
  static {
    ...
    tmpMap.put(_Fields.TASK_ID, new org.apache.thrift.meta_data.FieldMetaData("taskId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ALGO_ID, new org.apache.thrift.meta_data.FieldMetaData("algoId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.PLATFORM_ID, new org.apache.thrift.meta_data.FieldMetaData("platformId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.INPUT_FORMAT, new org.apache.thrift.meta_data.FieldMetaData("inputFormat", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.INPUT_PATH, new org.apache.thrift.meta_data.FieldMetaData("inputPath", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.OUTPUT_PATH, new org.apache.thrift.meta_data.FieldMetaData("outputPath", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PARAMETER_PATH, new org.apache.thrift.meta_data.FieldMetaData("parameterPath", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PACKAGE_PATH, new org.apache.thrift.meta_data.FieldMetaData("packagePath", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TASK_TYPE, new org.apache.thrift.meta_data.FieldMetaData("taskType", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.SUBMIT_TIME, new org.apache.thrift.meta_data.FieldMetaData("submitTime", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    tmpMap.put(_Fields.ACCESS_ID, new org.apache.thrift.meta_data.FieldMetaData("accessId", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ALGO_NAME, new org.apache.thrift.meta_data.FieldMetaData("algoName", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ACCESS_STATUS, new org.apache.thrift.meta_data.FieldMetaData("accessStatus", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ACCESS_PROGRESS, new org.apache.thrift.meta_data.FieldMetaData("accessProgress", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ALGO_DESCRIPTION, new org.apache.thrift.meta_data.FieldMetaData("algoDescription", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'algoId' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'platformId' because it's a primitive and you chose the non-beans generator.
    if (inputFormat == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'inputFormat' was not present! Struct: " + toString());
    }
    if (inputPath == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'inputPath' was not present! Struct: " + toString());
    }
    if (outputPath == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'outputPath' was not present! Struct: " + toString());
    }
    if (parameterPath == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'parameterPath' was not present! Struct: " + toString());
    }
    if (packagePath == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'packagePath' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'taskType' because it's a primitive and you chose the non-beans generator.
    if (submitTime == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'submitTime' was not present! Struct: " + toString());
    }
    if (startTime == null) {
    ...
    if (algoName == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'algoName' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'accessStatus' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'accessProgress' because it's a primitive and you chose the non-beans generator.
    if (algoDescription == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'algoDescription' was not present! Struct: " + toString());
    }
  ...
  private static class TaskMessageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TaskMessage> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TaskMessage struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetAlgoId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'algoId' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetPlatformId()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'platformId' was not found in serialized data! Struct: " + toString());
      }
      ...
      if (!struct.isSetAccessStatus()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'accessStatus' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetAccessProgress()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'accessProgress' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
